...
def main(config_file: str, dataset_folder: str, num_data_samples: int):
    ...
    with open('pose.csv', 'w') as pose_file:
        for i in range(num_data_samples):
            ...
            if measurement is None:
                print(f'Skipping annotation {i+1} due to invalid range.')
                continue
            ...
            pose_file.write(f"{random_pose[0]}\t{random_pose[1]}\n")

            print(f'annotation {i+1} created out of {num_data_samples}')
