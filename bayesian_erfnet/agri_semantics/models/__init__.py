...
from agri_semantics.models.models import ERFNet, AleatoricERFNet, EvidentialERFNet, UNet, SegFormer
...
def get_model(cfg, al_logger_name: str = "", al_iteration: int = 0, num_train_data: int = 1) -> LightningModule:
    ...
    if isinstance(cfg, dict):
        ...
        elif name == Models.SegFormer:
            return SegFormer(cfg, al_logger_name=al_logger_name, al_iteration=al_iteration, num_train_data=num_train_data)
        else:
